...
function draw_list_vertical_sub(item,thisIndex,crumbIndex,text_bc,crumbs,sublist){var crumbIndexIncrem=crumbIndex+1,text_bcIncrem=text_bc+'-'+thisIndex,countIndex=0;var html="<li id=\"vert-crumbs-"+(crumbIndexIncrem)+"\">";html+="<ul class=\"list vertical\" style=\"margin-left: "+(vert_indent)+"px;\" id=\"crumbs-"+(crumbIndexIncrem)+"\" breadcrumbs=\""+text_bcIncrem+"\">";$.each(item.children,function(key,value){html+=draw_list_item(this,crumbIndexIncrem,countIndex,text_bcIncrem,crumbs);var new_sublist=match_sublist(sublist,countIndex),drawSubList=false;if(isNumber(redrawing[crumbIndexIncrem])){if(redrawing[crumbIndexIncrem]===countIndex){}}
