...
<script type="text/javascript" src="<?php echo $ml; ?>js/autosize.js"></script>
<script type="text/javascript" src="<?php echo $ml; ?>common.js"></script>
<!--<script type="text/javascript" src="<?php echo $ml; ?>web.js"></script>-->
<script type="text/javascript" src="<?php echo $ml; ?>app.js"></script>
<script type="text/javascript" src="<?php echo $ml; ?>todo.js"></script>
<script type="text/javascript" src="<?php echo $ml; ?>design.js"></script>
<script type="text/javascript" src="<?php echo $ml; ?>data.js"></script>
<script type="text/javascript" src="<?php echo $ml; ?>details.js"></script>
<script type="text/javascript" src="<?php echo $ml; ?>magic.js"></script>
